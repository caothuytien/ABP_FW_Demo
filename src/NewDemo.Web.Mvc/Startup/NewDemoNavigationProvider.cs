...
namespace NewDemo.Web.Startup
{
    ...
    /// </summary>
    public class NewDemoNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                .AddItem(
                    ...
                    //    new MenuItemDefinition(
                    //        "AddProduct",
                    //        new FixedLocalizableString("Add Product"),
                    //        url: "AddProducts"
        ...
        {
            return new LocalizableString(name, NewDemoConsts.LocalizationSourceName);
        }
    }
}
